...
export default function EmployeePerformanceFeedback() {
    ...
    const defaultForm = {
        ...
        reviewer: '', reviewer_name: '', reviewer_designation: '', user: '',
    ...
    const fetchSingle = async (name) => {
        try {
            ...
            setFormData({
                ...
                reviewer_designation: d.reviewer_designation || '', user: d.user || '',
                added_on: d.added_on || '',
            ...
            <div className="p-6 max-w-5xl mx-auto">
                ...
                <div className="flex justify-between items-start mb-6 pb-4 border-b border-gray-200">
                    <div className="flex items-center gap-2">
                        <span className="text-xl font-bold text-gray-900">{editingRecord ? editingRecord.name : 'New Employee Performance Feedback'}</span>
                        {!editingRecord ? (
                    ...
                    <div className="p-6">
                        ...
                        {formTab === 'employee_details' && (
                            <div className="space-y-5">
                                {/* Row 1: For Employee | Reviewer | Added On */}
                                ...
                                {/* Row 2: Employee Name | Reviewer Name | Appraisal Cycle */}
                                <div className="grid grid-cols-3 gap-x-6 gap-y-4 max-w-5xl">
                                    <div>
                                ...
                                {/* Row 3: Department | Designation (reviewer's) */}
                                <div className="grid grid-cols-3 gap-x-6 gap-y-4 max-w-5xl">
                                    <div>
                                ...
                                {/* Row 4: Designation (employee's) | User */}
                                <div className="grid grid-cols-3 gap-x-6 gap-y-4 max-w-5xl">
                                    <div>
                                        <label className="block text-[13px] text-gray-500 mb-1">Designation</label>
    ...
    return (
        <div className="p-6">
            <div className="flex justify-between items-center mb-6">
                <h1 className="text-2xl font-semibold text-gray-800">Employee Performance Feedback</h1>
