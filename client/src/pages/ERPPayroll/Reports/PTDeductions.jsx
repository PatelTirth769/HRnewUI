...
export default function PTDeductions() {
    ...
    const handleExport = () => {
        ...
        XLSX.utils.book_append_sheet(wb, ws, "PT Deductions");
        XLSX.writeFile(wb, `PT_Deductions_${months.find(m => m.value === month)?.label}_${year}.xlsx`);
    };
    ...
    return (
        <div className="flex flex-col h-[calc(100vh-64px)] bg-[#f3f4f6] relative font-sans p-6 overflow-hidden">
            ...
            <div className="flex justify-between items-center mb-4">
                <h1 className="text-[1.35rem] font-bold text-gray-900 m-0 truncate">Professional Tax Deductions</h1>
