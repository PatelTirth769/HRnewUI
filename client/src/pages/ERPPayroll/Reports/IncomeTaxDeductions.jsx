...
export default function IncomeTaxDeductions() {
    ...
    const handleExport = () => {
        ...
        XLSX.utils.book_append_sheet(wb, ws, "Income Tax Deductions");
        XLSX.writeFile(wb, `Income_Tax_Deductions_${months.find(m => m.value === month)?.label}_${year}.xlsx`);
    };
    ...
    return (
        <div className="flex flex-col h-[calc(100vh-64px)] bg-[#f3f4f6] relative font-sans p-6 overflow-hidden">
            ...
            <div className="flex justify-between items-center mb-4">
                <h1 className="text-[1.35rem] font-bold text-gray-900 m-0 truncate">Income Tax Deductions</h1>
