...
const AssetMaintenanceReport = () => {
    ...
    const fetchMasters = async () => {
        try {
            const [cR, aR, catR] = await Promise.all([
    ...
    const runReport = async () => {
        try {
            setLoading(true);
            const params = new URLSearchParams({ report_name: 'Asset Maintenance' });
            const filterObj = {};
    ...
    return (
        <div className="p-6 max-w-7xl mx-auto font-sans">
            <div className="flex justify-between items-center mb-6">
                <h1 className="text-2xl font-bold text-gray-900">Asset Maintenance Report</h1>
