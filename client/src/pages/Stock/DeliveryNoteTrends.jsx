...
export default function DeliveryNoteTrends() {
    ...
    return (
        <div className="p-6 max-w-[1400px] mx-auto text-gray-800">
            ...
            <div className="flex justify-between items-center mb-6">
                <h1 className="text-[24px] font-bold text-gray-900 tracking-tight">Delivery Note Trends</h1>
                    ...
                    <div className="grid grid-cols-5 gap-4">
                        ...
                        <div>
                            ...
                            <Select
                                ...
                                options={[{value:'Item',label:'Item'},{value:'Item Group',label:'Item Group'},{value:'Customer',label:'Customer'},{value:'Customer Group',label:'Customer Group'},{value:'Territory',label:'Territory'}]}
                            />
                        </div>
                        <div>
                            ...
                            <Select
                                ...
                                options={[{value:'',label:'None'},{value:'Item',label:'Item'},{value:'Item Group',label:'Item Group'},{value:'Customer',label:'Customer'},{value:'Customer Group',label:'Customer Group'},{value:'Territory',label:'Territory'}]}
                            />
                        </div>
                        <div>
                ...
                <div className="min-h-[400px] bg-[#fbfcfd] border-t border-gray-100 flex flex-col items-center justify-center p-8 relative">
                    {loading ? (
                        <div className="flex flex-col items-center gap-3">
                            <Spin size="large" />
                            <span className="text-sm text-gray-400 font-medium">Analyzing Delivery Trends...</span>
                        </div>
                    ) : reportData.length > 0 ? (
