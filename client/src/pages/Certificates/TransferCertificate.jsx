...
export default function TransferCertificate() {
    ...
    const handleProgramChange = (value) => {
        ...
        if (value) {
            ...
            form.setFieldsValue({ classLastStudied: value });
        ...
        setSelectedGroup('');
        form.setFieldsValue({ studentGroup: '', studentSearch: undefined, studentName: '', grNo: '', rollNo: '', motherName: '', fatherName: '' });
        setStudentsInGroup([]);
    };
    ...
    const handleStudentSearch = async (value) => {
        ...
        try {
            const res = await API.get(
                `/api/resource/Student?filters=[["student_name","like","%${value}%"]]&fields=["name","student_name","first_name","middle_name","last_name","gender","date_of_birth","program","roll_number","gr_number","nationality","joining_date"]&limit_page_length=20`
            );
