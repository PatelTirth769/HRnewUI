...
export default function StudentCategory() {
    ...
    const fetchData = async () => {
        ...
        try {
            ...
            notification.error({ message: 'Failed to load Student Categories' });
    ...
    const handleDelete = async () => {
        ...
        try {
            await API.delete(`/api/resource/Student Category/${encodeURIComponent(editingRecord.name)}`);
                    ...
                    <div>
                        <div className="flex items-center gap-2 mb-1">
                            <span className="text-xl font-bold text-gray-900 tracking-tight">
                                {editingRecord ? editingRecord.name : 'New Student Category'}
                            </span>
                            {!editingRecord ? (
    ...
    return (
        <div className="p-6">
            <div className="flex justify-between items-center mb-6">
                <h1 className="text-2xl font-semibold text-gray-800">Student Category</h1>
            ...
            <div className="flex items-center gap-3 mb-4 flex-wrap">
                <input type="text" className="border border-gray-300 rounded px-3 py-2 text-sm w-64" placeholder="Search Category..." value={searchId} onChange={(e) => setSearchId(e.target.value)} />
            ...
            <div className="bg-white rounded-lg border border-gray-200 overflow-hidden">
                {loading ? (
                    ...
                    <div className="text-center py-12 text-gray-500">
                        <p className="text-lg mb-2">No Student Categories found</p>
                    ...
                    <table className="w-full text-sm">
                        <thead className="bg-gray-50 border-b">
                            <tr>
                                <th className="text-left px-4 py-3 font-medium text-gray-600">Student Category</th>
