    ...
    const fetchData = async () => {
        ...
        try {
            ...
            const res = await API.get(`/api/resource/Attendance`, {
                params: {
                    fields: JSON.stringify(["name","attendance_date","status","out_time","early_exit","shift"]),
            ...
            console.error(err);
            notification.error({ message: 'Failed to fetch early go report' });
        } finally {
            setLoading(false);
        }
    };
    ...
    return (
        <div className="space-y-4">
            <div className="flex flex-wrap items-center gap-4 mb-4">
                ...
                <span className="text-sm text-gray-500">{data.length} early exits found</span>
            </div>
