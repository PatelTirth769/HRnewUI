...
import { FiFileText, FiRefreshCw, FiEye } from 'react-icons/fi';
...
export default function EnquiryCustomReport() {
    ...
    return (
        <div className="p-6 max-w-[1600px] mx-auto font-inter text-gray-800">
            <div className="flex justify-between items-center mb-6">
                <div>
                    <h1 className="text-2xl font-black text-gray-900 tracking-tight">Enquiry Custom Report</h1>
                    <div className="flex items-center gap-2 text-[12px] text-gray-500 mt-1 font-medium">
                        <span>Home</span> / <span>Enquiry Module</span> / <span>Report</span> / <span className="text-blue-600 font-bold">Enquiry Custom Report</span>
                    </div>
                </div>
            </div>
