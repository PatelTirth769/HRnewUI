...
const SetFacultyReassessment = () => {
  ...
  const fetchPendingReassessments = async () => {
    try {
      const response = await axios.get('/api/education/reassessments/pending');
  ...
  const fetchAvailableFaculties = async () => {
    try {
      const response = await axios.get('/api/education/faculties/available/assign');
  ...
  const handleAssignFaculty = async (e) => {
    ...
    try {
      await axios.put(`/api/education/reassessments/${selectedReassessment}/assign-faculty/${selectedFaculty}`);
