...
const [filteredRules, setFilteredRules] = useState([]);
  ...
  const fetchAttendanceRules = async () => {
    setLoading(true);
    try {
      const response = await axios.get('/api/education/attendance-eligibility');
  ...
  const fetchInstitutes = async () => {
    try {
      const response = await axios.get('/api/education/institutes');
      // Ensure response.data is always an array
  ...
  const fetchPrograms = async () => {
    try {
      const response = await axios.get('/api/education/programs');
      // Ensure response.data is always an array
  ...
  const fetchExamTerms = async () => {
    try {
      const response = await axios.get('/api/education/exam-terms');
      // Ensure response.data is always an array
  ...
  const fetchYears = async () => {
    try {
      const response = await axios.get('/api/education/manage-years');
      // Ensure response.data is always an array
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (isEditing) {
        await axios.put(`/api/education/attendance-eligibility/${currentId}`, submitData);
        toast.success('Attendance eligibility rule updated successfully');
      } else {
        await axios.post('/api/education/attendance-eligibility', submitData);
  ...
  const handleDelete = async (id) => {
    if (window.confirm('Are you sure you want to delete this rule?')) {
      setLoading(true);
      try {
        await axios.delete(`/api/education/attendance-eligibility/${id}`);
  ...
  const handleFileUpload = async (e) => {
    ...
    fileReader.onload = async (e) => {
      try {
        ...
        setLoading(true);
        await axios.post('/api/education/attendance-eligibility/upload', { data });
