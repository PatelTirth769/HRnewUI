...
const ManageExamCenter = () => {
  ...
  const fetchExamCenters = async () => {
    setLoading(true);
    try {
      const response = await axios.get('/api/education/manage-exam-center');
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (editMode) {
        await axios.put(`/api/education/manage-exam-center/${currentId}`, formData);
        toast.success('Exam center updated successfully');
      } else {
        await axios.post('/api/education/manage-exam-center', formData);
  ...
  const handleDelete = async (id) => {
    ...
    setDeleteLoading(id);
    try {
      await axios.delete(`/api/education/manage-exam-center/${id}`);
  ...
  const handleFileUpload = async (e) => {
    ...
    try {
      const response = await axios.post('/api/education/manage-exam-center/upload', formData, {
        headers: {
