...
const ManageDegree = () => {
  ...
  const fetchDegrees = async () => {
    try {
      const response = await axios.get('/api/education/degrees');
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (isEditing) {
        await axios.put(`/api/education/degrees/${currentId}`, formData);
        toast.success('Degree updated successfully');
      } else {
        await axios.post('/api/education/degrees', formData);
  ...
  const handleDelete = async (id) => {
    if (window.confirm('Are you sure you want to delete this degree?')) {
      try {
        await axios.delete(`/api/education/degrees/${id}`);
  ...
  const handleFileUpload = async (e) => {
    ...
    try {
      await axios.post('/api/education/degrees/upload', formData, {
        headers: {
