...
const ManageStudentDetail = () => {
  ...
  const fetchStudents = async () => {
    try {
      const response = await axios.get('/api/education/students');
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (isEditing) {
        await axios.put(`/api/education/students/${currentId}`, formData);
        toast.success('Student details updated successfully');
      } else {
        await axios.post('/api/education/students', formData);
  ...
  const handleDelete = async (id) => {
    if (window.confirm('Are you sure you want to delete this student?')) {
      try {
        await axios.delete(`/api/education/students/${id}`);
  ...
  const handleFileUpload = async (e) => {
    ...
    try {
      await axios.post('/api/education/students/upload', formData, {
        headers: {
  ...
  const handleExport = async () => {
    try {
      const response = await axios.get('/api/education/students/export', {
        responseType: 'blob'
      });
