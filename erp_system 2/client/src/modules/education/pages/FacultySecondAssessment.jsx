...
const FacultySecondAssessment = () => {
  ...
  const fetchFaculties = async () => {
    try {
      const response = await axios.get('/api/education/faculties');
  ...
  const fetchFacultyAssessments = async (facultyId) => {
    try {
      const response = await axios.get(`/api/education/reassessments/faculty/${facultyId}`);
  ...
  const handleUpdateMarks = async (assessmentId) => {
    ...
    try {
      await axios.put(`/api/education/reassessments/${assessmentId}/update-marks`, {
