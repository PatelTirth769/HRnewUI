...
function MarksEntryChecklistReport() {
  ...
  useEffect(() => {
    const fetchChecklistData = async () => {
      try {
        setLoading(true);
        const response = await axios.get('/api/education/marks-entry-checklist');
  ...
  const handleSearch = async (e) => {
    ...
    try {
      setLoading(true);
      const response = await axios.get('/api/education/marks-entry-checklist', { params: formData });
      setChecklistData(Array.isArray(response.data) ? response.data : []);
    } catch (error) {
  ...
  const handleExcelUpload = async (e) => {
    ...
    try {
      setLoading(true);
      await axios.post('/api/education/marks-entry-checklist/upload', uploadFormData, {
        headers: {
  ...
  const handleExcelDownload = async () => {
    try {
      const response = await axios.get('/api/education/marks-entry-checklist/download', {
        responseType: 'blob'
      });
