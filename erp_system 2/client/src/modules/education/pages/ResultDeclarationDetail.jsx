...
const ResultDeclarationDetail = () => {
  ...
  useEffect(() => {
    const fetchDeclarations = async () => {
      try {
        const response = await axios.get('/api/education/result-declaration-detail');
  ...
  const handleActionClick = async (action) => {
    try {
      ...
      const response = await axios.post(`/api/education/result-declaration-detail/${action}`, { 
        ...formData, 
        resultDetails 
      });
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await axios.post('/api/education/result-declaration-detail', { 
        ...formData, 
        resultDetails 
      });
