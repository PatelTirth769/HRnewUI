...
const SetReassessmentFees = () => {
  ...
  useEffect(() => {
    ...
    // axios.get('/api/education/reassessment-fees').then(response => setSavedFees(response.data));
  }, []);
  ...
  const handleSave = () => {
    // Save data to API
    // axios.post('/api/education/reassessment-fees', { ...formData, feeDetails }).then(response => {
