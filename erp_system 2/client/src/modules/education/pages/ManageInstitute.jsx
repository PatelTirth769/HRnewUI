...
const ManageInstitute = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (isEditing) {
        await axios.put(`/api/education/institutes/${currentId}`, formData);
        toast.success('Institute updated successfully');
      } else {
        await axios.post('/api/education/institutes', formData);
  ...
  const handleDelete = async (id) => {
    if (window.confirm('Are you sure you want to delete this institute?')) {
      try {
        await axios.delete(`/api/education/institutes/${id}`);
  ...
  const handleFileUpload = async (e) => {
    ...
    try {
      await axios.post('/api/education/institutes/upload', formData, {
        headers: {
