...
function ManageSubjectHead() {
  ...
  useEffect(() => {
    ...
    const fetchSubjectHeads = async () => {
      try {
        ...
        const response = await axios.get('/api/education/subject-heads');
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (isEditing) {
        await axios.put(`/api/education/subject-heads/${currentId}`, formData);
        toast.success('Subject head updated successfully');
      } else {
        await axios.post('/api/education/subject-heads', formData);
                      ...
                      <button
                        onClick={async () => {
                          if (window.confirm('Are you sure you want to delete this subject head?')) {
                            try {
                              await axios.delete(`/api/education/subject-heads/${head._id}`);
