...
const ApplyNearestMarks = () => {
  ...
  const fetchYears = async () => {
    try {
      const response = await axios.get('/api/education/years');
  ...
  const fetchReassessments = async () => {
    try {
      setLoading(true);
      let url = '/api/education/reassessments';
      const params = [];
  ...
  const handleApplyNearestMarks = async (reassessmentId) => {
    try {
      ...
      await axios.put(`/api/education/reassessments/${reassessmentId}/apply-nearest-marks`, {
